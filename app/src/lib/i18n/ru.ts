...
const messages: TranslationMap = {
  ...
  'mnemonic.importOverflowWarning':
    'Вы вставили {pasted} слов, но свободных полей осталось только {slots}. Слова, которые не поместились, не были введены. Вставьте фразу целиком в пустое поле, чтобы импортировать её полностью.',
