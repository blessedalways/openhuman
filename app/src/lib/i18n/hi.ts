...
const messages: TranslationMap = {
  ...
  'mnemonic.importOverflowWarning':
    'आपने {pasted} शब्द पेस्ट किए, लेकिन सिर्फ़ {slots} खाली बॉक्स बचे हैं। जो शब्द समा नहीं पाए वे भरे नहीं गए। पूरा वाक्यांश आने के लिए उसे किसी खाली बॉक्स में पेस्ट करें।',
